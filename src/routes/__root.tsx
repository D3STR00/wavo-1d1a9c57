...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wavo — Real-time intent, near you" },
      {
        name: "description",
        content:
          "Wavo is a real-time intent network. Say what you want to do right now — coffee, walk, talk, gym — and match with people nearby who are down.",
      },
